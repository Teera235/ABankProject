...
#define MPU6050_AXOFFSET -1
#define MPU6050_AYOFFSET -1
#define MPU6050_AZOFFSET -1
...
#define MPU6050_GXOFFSET -1
#define MPU6050_GYOFFSET -1
#define MPU6050_GZOFFSET -1
...
WiFiClient client;
const char* server = "192.168.1.49";
const int port = 80;
...
void loop() {
  ...
  // ส่งค่า pitch, roll, yaw ไปยังเซิร์ฟเวอร์
...
void sendData() {
  String jsonData = "{\"pitch\": " + String(pitch, 2) +
                    ", \"roll\": " + String(roll, 2) +
                    ", \"yaw\": " + String(yaw, 2) + "}";
